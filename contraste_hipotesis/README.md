...
# Description
Interactive simulator to visualise the p-value, the critical region and the decision of a hypothesis test according to the significance level.

# Authors
Francisco Sánchez-Sáez

# App
https://statio.webs.upv.es/StatisticalSimulators/contraste_hipotesis/

# GitHub
https://github.com/STATIO-UPV/StatisticalSimulators/tree/main/contraste_hipotesis
